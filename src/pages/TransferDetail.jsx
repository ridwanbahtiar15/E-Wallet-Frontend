    ...
    <>
      <Title title={"Transfer"}>
        ...
        <section className="flex">
          <div className="lg:w-[20%] hidden lg:block py-[24px] px-[42px] border-r-[1px]">
              ...
              <svg width={20} height={22} viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Upload">
                  ...
                  <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.08471 4.92868C6.89371 4.92868 6.70171 4.85568 6.55571 4.70968C6.26271 4.41768 6.26071 3.94368 6.55371 3.64968L9.46871 0.72168C9.74971 0.43868 10.2497 0.43868 10.5307 0.72168L13.4467 3.64968C13.7387 3.94368 13.7377 4.41768 13.4447 4.70968C13.1507 5.00168 12.6767 5.00168 12.3847 4.70768L9.99971 2.31368L7.61571 4.70768C7.46971 4.85568 7.27671 4.92868 7.08471 4.92868Z"
                    fill="#4F5665"
                  />
                </g>
              </svg>
              ...
              <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="2 User">
                  <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.59102 12.7068C11.28 12.7068 14.433 13.2658 14.433 15.4988C14.433 17.7318 11.301 18.3068 7.59102 18.3068C3.90102 18.3068 0.749023 17.7528 0.749023 15.5188C0.749023 13.2848 3.88002 12.7068 7.59102 12.7068Z"
                    stroke="#4F5665"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  ...
                  <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.59108 9.51979C5.16908 9.51979 3.20508 7.55679 3.20508 5.13479C3.20508 2.71279 5.16908 0.749786 7.59108 0.749786C10.0121 0.749786 11.9761 2.71279 11.9761 5.13479C11.9851 7.54779 10.0351 9.51079 7.62208 9.51979H7.59108Z"
                    stroke="#4F5665"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
