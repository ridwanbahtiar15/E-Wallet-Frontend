      ...
      <div className="h-screen flex items-center">
        <div className="flex-1 py-5 h-auto md:flex-initial md:w-2/3 lg:w-1/2 bg-white font-montserrat mx-5 lg:m-0 lg:p-10 md:rounded-r-full">
          <div className="flex flex-col gap-[13px]">
            ...
            <p className="text-xs md:leading-6 font-normal">
              ...
              >
                ...
                <div className="flex gap-[15px] px-3 py-[14px] border border-[#DEDEDE] rounded-lg bg-#FCFDFE">
                  ...
                  <input
                    ...
                    id="password"
                    className="flex-1 outline-none text- font-normal text-[#4F5665]"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full p-[10px] h-[50px] text-white bg-[#2948FF] hover:bg-blue-700 rounded-md"
                >
                  Login
                </button>
              </form>
