    ...
    <>
      <main className="font-montserrat">
        ...
        <div className="pt-16 pb-10">
          <div className="flex flex-col gap-7 px-10 justify-items-center">
            <div className="flex flex-col gap-[15px]">
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <p className="text-center text-base font-normal">We have 24/7 contact support so you can contact us whenever you want and we will respond it.</p>
              </div>
            </div>
            <div className="flex flex-col gap-[15px]">
              <div className="flex justify-center">
              ...
              <div className="flex flex-col gap-[15px]">
                <p className="text-center font-bold text-lg">Data Privacy</p>
                <p className="text-center text-base font-normal">We make sure your data is safe in our database and we will encrypt any data you submitted to us.</p>
              </div>
            </div>
            <div className="flex flex-col gap-[15px]">
              <div className="flex justify-center">
              ...
              <div className="flex flex-col gap-[15px]">
                <p className="text-center font-bold text-lg">Easy Download</p>
                <p className="text-center text-base font-normal">Zwallet is 100% totally free to use it&apos;s now available on Google Play Store and App Store.</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col-reverse">
            <div className="flex flex-col px-10 pt-7 gap-5">
              <p className="text-[#2948FF] font-bold text-lg text-center ">WELCOME TO E-WALLET</p>
              <p className="font-medium text-[32px] text-center">Your All-in-One Digital Payment Solution</p>
              ...
              <button className="h-[50px] justify-center bg-[#2948FF] text-white py-[10px] rounded-md">Get Started</button>
            </div>
            <div className="relative mt-[300px] bottom-0 px-10 flex justify-center">
              <img className="relative bottom-0 max-h-[322px] " src="/img/Group-1308.webp" alt="background-img" />
              <img className="absolute bottom-0 " src="/img/mobile-dashboard-2.webp" alt="mobile-dashboard-img-2" />
            </div>
          </div>
        </div>
        <div className="bg-[#F8F8F8] px-10 py-14 flex flex-col items-center">
          <div>
          ...
          <div>
            <div className="flex flex-col gap-[25px]">
              ...
              <button className="h-[50px] bg-[#2948FF] text-white text-sm py-[10px] rounded-md">Get Started</button>
            </div>
          </div>
        </div>
        <div className="px-10 py-14 flex flex-col items-center gap-[19px]">
          <p className="font-medium text-[32px] text-center">100+ Trusted Partners</p>
          <p className="font-normal text-base text-center">We have reached global level and have 100+ brand partners around the globe.</p>
          <div>
        ...
        <div className="px-10 py-14 flex flex-col items-center gap-[19px]">
          ...
          <div className="flex flex-col items-center mt-10 text-white gap-[19px] bg-[#2948FF] rounded-2xl p-14">
        ...
        <div className="flex flex-col bg-[#F8F8F8] px-10 py-14 gap-[19px] ">
          ...
          <div className="flex gap-[25px]">
            <button className="flex flex-1 items-center justify-center h-[50px] border bg-[#2948FF] rounded-md gap-[10px]">
              <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="flex flex-1 items-center justify-center text-[#2948FF] h-[50px] border gap-[10px] rounded-md border-[#2948FF] ">
          ...
          <img src="/img/mobile-dashboard-3.webp" alt="mobile-dashboard-3-img" />
        </div>
      </main>
    </>
  );
