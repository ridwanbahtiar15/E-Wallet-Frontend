        ...
        <main className="flex">
          <aside className="xl:w-1/5 border-r border-[#E8E8E8] py-6 px-11 hidden lg:block">
            <div className="flex flex-col gap-y-4">
              <Link to="/dashboard" className="flex items-center gap-x-2 py-2 px-4 hover:bg-primary rounded-md outline-none text-sm font-normal text-secondary">
                <div>
              ...
              <Link to="/transfer" className="flex items-center gap-x-2 py-2 px-4 bg-primary rounded-md outline-none text-base font-normal text-light">
                <div>
            ...
            <div className="lg:flex hidden items-center gap-[13px]">
              ...
              <div className="border-[1px] mt-4 pt-[26px] lg:pl-[31px] px-5 pb-[43px] lg:pr-[27px]">
                      ...
                      <div className="w-[60%] text-center">
                        <ul>
                          {nameList
                            ...
                            .map((item) => {
                              return <li className="py-[34px] text-[#4F5665] font-montserrat text-sm">{item.full_name}</li>;
                            })}
                        </ul>
                      </div>
                      <div className="w-[40%] text-center">
                        <ul>
                          {nameList
                            ...
                            .map((item) => {
                              return <li className="py-[34px] text-[#4F5665] font-montserrat text-sm">Phone</li>;
                            })}
                        </ul>
                      </div>
                    </div>
                            ...
                            <tr className={`border-b border-[#E8E8E84D] ${i % 2 == 0 ? "bg-[#F9FAFB]" : ""}`} key={i}>
                              <td className="p-6">
                                <div className="flex justify-center">
                                  <img src={result.photo_profile} alt="product" className="w-12 rounded-md" />
                                </div>
                              </td>
                              <td className="p-6 text-center">{result.full_name}</td>
                              <td className="p-6 text-center">{result.phone_number}</td>
                ...
                <section className="">
                  ...
                  <div id="People_Identity" className="text-sm mb-[26px] px-5 py-2.5 flex bg-[#e8e8e8] gap-5 rounded-md">
                    <div >
                      <img src={nameList.photo_profile} alt="photo_profile" className="w-[80px] h-[80px] rounded-md" />
                    </div>
                  ...
                  <div id="notes_input" className="mb-[26px]">
                    ...
                    <div className="flex border border-solid border-[#E8E8E8] rounded-md gap-2.5 items-center p-2.5">
                      <input type="Number" className="text-sm font-semibold flex-1 outline-none h-[223px]" placeholder="Enter Some Notes"/>
                    </div>
                  </div>
                  <button className="flex w-full text-sm justify-center font-montserrat p-2 bg-[#2948FF] rounded-md text-white">
                    Submit & Transfer
                  </button>
                </section>}
              </div>
