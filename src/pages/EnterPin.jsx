            ...
            <div className='flex bg-[#3969FD] h-screen lg:p-0 p-[60px]'>
                ...
                <div className='bg-white lg:rounded-r-[40px] rounded-[20px] lg:rounded-none lg:w-[50%] w-full flex justify-center items-center p-[10px]'>
                    ...
                    <div>
                        ...
                        <button className='bg-[#2948FF] w-full p-[10px] text-white rounded-md font-montserrat text-base font-medium hover:opacity-80 mb-[13px]' onClick={handleClick}>Submit</button>

                        <div>

                            <h1 className='text-[#4F5665] text-base font-montserrat text-center'>Forgot Your Pin? <span className='text-[#2948FF] cursor-pointer hover:opacity-80'>Reset</span></h1>
