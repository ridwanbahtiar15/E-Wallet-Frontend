  ...
  return (
    <>
      <Title title={"History"}>
              ...
              <div className="flex flex-col gap-y-4 md:gap-x-5">
                <section className="py-4 px-3 border border-[#E8E8E8] rounded-md flex flex-col gap-y-4">
                  ...
                  <div className="flex justify-between px-4">
                    <p className="text-xs font-normal text-secondary">Show 5 History of 100 History</p>
        ...
        {openModal.isOpen && <Modal modal={openModal} closeModal={setOpenModal} message={Message} dataUser={setUser} />}
      </Title>
    </>
  );
}
