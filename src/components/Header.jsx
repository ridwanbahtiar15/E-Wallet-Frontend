    ...
    <>
      <header className="sticky top-0 z-50 flex justify-between items-center w-full h-[76px] px-[40px] text-white bg-[#2948FF]">
        ...
        <div className="hidden md:flex md:gap-2">
          <button className="border border-white h-[48px] py-3 px-4 rounded-md hover:bg-blue-700"><Link to="/login" >Sign In</Link></button>
          <button className="border text-[#2948FF] bg-white border-white h-[48px] py-3 px-4 rounded-md hover:bg-slate-200"><Link to="/register" >Sign Up</Link></button>
        </div>
      </header>
    </>
  );
